package BusAndTicketReserve.BusReserveAndTicketing;
import java.io.*;
...
for(int o=1; o<=5; o++){available[o]=20;
  		}
...
System.out.println("** 1.)Wayanad   | RS1000|   "+available[1]+"   **");
    					
System.out.println("** 2.)Kochi     | RS600 |   "+available[2]+"   **");
    					
System.out.println("** 3.)Idukki    | RS500 |   "+available[3]+"   **");
    					
System.out.println("** 4.)Kollam    | RS200 |   "+available[4]+"   **");
    					
System.out.println("** 5.)Alappuzha | RS300 |   "+available[5]+"   **");
...
String dest[] = { " ", "Wayanad", "Kochi", "Idukki", "Kollam", "Alappuzha"};
    					
double fare[] = { 0,1000,600,500,200,300};
...
//subtract the available seat by the number input//
for(int p=1; p<=5; p++)
{
...
//add the input number to the subtracted seat, to back the original seat//
    								
//display the available seat and back to the input//
...
//input for Number of Discounted Passenger's//
